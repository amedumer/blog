...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "amedumer.blog.blog.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "amedumer.blog.blog.MsgCreatePostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	0xd7, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x4a, 0xcc, 0x4d, 0x4d, 0x29,
	0xcd, 0x4d, 0x2d, 0xd2, 0x03, 0x89, 0x83, 0x09, 0xa5, 0x60, 0x2e, 0x5e, 0xdf, 0xe2, 0x74, 0xe7,
	...
	0xd4, 0xc3, 0x74, 0xa7, 0x1e, 0x8a, 0x79, 0x52, 0x9a, 0x04, 0x95, 0xc0, 0xac, 0x74, 0xb2, 0x3f,
	...
	0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x98, 0x71, 0xfa, 0xe0, 0x10, 0xab, 0x80, 0x50, 0x25, 0x95,
	0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0xc0, 0x33, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xd6, 0x6e,
	0x14, 0x92, 0x4d, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/amedumer.blog.blog.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/amedumer.blog.blog.Msg/CreatePost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "amedumer.blog.blog.Msg",
